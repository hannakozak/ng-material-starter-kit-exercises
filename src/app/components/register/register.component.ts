...
export class RegisterComponent {
  readonly registerForm: FormGroup = new FormGroup({ email: new FormControl(), username: new FormControl(), password: new FormControl(), firstname: new FormControl(), lastname: new FormControl(), city: new FormControl(), street: new FormControl(), number: new FormControl(), zipcode: new FormControl(), phone: new FormControl() });
  ...
  onRegisterFormSubmitted(registerForm: FormGroup): void {
    this._registerService.register({
      ...
      phone: registerForm.get('phone')?.value }).subscribe();
  }
}
